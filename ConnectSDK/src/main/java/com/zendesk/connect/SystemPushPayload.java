 ...
 */
public class SystemPushPayload implements Parcelable {
    ...
    protected SystemPushPayload(Parcel in) {
    ...
    public static final Creator<SystemPushPayload> CREATOR = new Creator<SystemPushPayload>() {
        @Override
        public SystemPushPayload createFromParcel(Parcel in) {
            return new SystemPushPayload(in);
        }

        @Override
        public SystemPushPayload[] newArray(int size) {
            return new SystemPushPayload[size];
        }
    };
    ...
    public boolean equals(Object o) {
        ...
        SystemPushPayload payload1 = (SystemPushPayload) o;
